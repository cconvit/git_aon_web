...
if (isset($_REQUEST["id"])) {
    ...
    $cotizacion_aux->id = $carro->id_cotizacion;
    $cotizacion = $cotizacion_aux->find_by_id();
    $cotizacion = $cotizacion[0];

    $inma_flota = new inma_flota();
    $inma_flota->id_flota = $cotizacion->id_flota;
                        ...
                        <td>
                            ...
                            if ($carro->is_car_marca == 1 && $carro->is_car_modelo == 1) {
                                ...
                                <ul id="version" class="vehicle-suggestion-list reset" role="version" data="selected">
                                    <li data="<?php echo $carro->car_version; ?>" role="selected" tab-index='1'><span class="icon-mini icon-clear img-common icon-selected"></span><span title="<?php echo $carro->car_version; ?>"><?php echo $carro->car_version; ?></span></li>
                                <?php } else { ?>
                                        ...
                                        <td>
                                            ...
                                            if ($carro->is_car_marca == 1 && $carro->is_car_modelo == 1) {
                                                ...
                                                <td>
                                                    ...
                                                    <input name="inma-porcentaje" type="hidden" value="<?php echo $carro->porcentaje_inma; ?>">
                                                </td>
                                                <td>
