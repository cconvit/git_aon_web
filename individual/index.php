...
if (isset($id_flota)) {
    ...
    if (sizeof($result) > 0) {
        ...
        $inma_flota->id_flota = $result[0]->id;
        $inmas = $inma_flota->find_inma_by_flota();
        ?>
        <!DOCTYPE html>
        <html>
            <head>
                ...
                <div id="contenedor">
                    ...
                    <div id="header">
                        <div class="center">
                            ...
                            <p><a href="index.php?i=<?php echo $flota->id;?>"><img src="img/logo.png"></a></p>S
                        ...
                        <div class="center">
                            ...
                            <div id="legal">
                                <ul>
                                    ...
                                    <li>los <a href="terminos.html" class="destacado" target="_blank" onClick="window.open(this.href, this.target, 'width=500, height=400, resizable=0');">Términos de Uso</a> publicados en esta página.  Operar con el cotizador en línea implica aceptar los <a href="terminos.html" class="destacado" target="_blank" onClick="window.open(this.href, this.target, 'width=500, height=400, resizable=0');">Términos de Uso</a> en los que se ofrece el servicio.</li>
                                    <li style="width: 220px;">
                                        <input type="checkbox" id="acepto" name="acepto">
                                        <label for="acepto" style="padding-left: 5px;">He leído y aceptado los <a href="terminos.html" class="destacado" target="_blank" onClick="window.open(this.href, this.target, 'width=500, height=400, resizable=0');">Términos de Uso</a> y la <a href="legal.html" class="destacado" target="_blank" onClick="window.open(this.href, this.target, 'width=500, height=300, resizable=0');">Información Legal</a></label>
                                    </li>
                                </ul>
