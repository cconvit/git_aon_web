...
<div id="contenedor">
	...
	<div id="contenido">
		<div class="center">
			<form id="form-datos" action="aseguradoras.php" method="POST">
				<ul>
					...
					<li>
						...
						<table class="tbl-datos">
							<tr>
								<td>
									<input type="radio" name="tipo" value="usado" checked>
									<span class="label">Usado</span>
									<input type="radio" name="tipo" value="nuevo" style="margin-left: 15px">
							...
							<tr>
								<td class="padding">
									<select id="marca" class="required">
										<option value="select" selected>Seleccion una marca</option>
									</select>
									<input type="hidden" id="txt-marca" name="marca" value="none">
								</td>
							</tr>
							<tr>
								<td>Modelo</td>
							...
							<tr>
								<td class="padding">
									<select id="modelo" class="required">
										<option value="select" selected>Seleccion un modelo</option>
									</select>
									<input type="hidden" id="txt-modelo" name="modelo" value="none">
								</td>
							</tr>
							<tr>
								<td>Versión</td>
							...
							<tr>
								<td class="padding">
									<select id="version" class="required" name="version">
						...
						<table class="tbl-datos">
							...
							<tr>
								<td><select class="required no-precharged" name="cobertura">
										...
										<option value="1">Perdita total</option>
	...
	<div id="mensaje">
		<div class="center">
			...
			<span id="error" class="red pull-rigth hide"></span> </div>
	</div>
	<div id="footer">
		<div class="center">
			...
			<div id="legal">
				<ul>
					...
					<li>los <a class="destacado" href="terminos.html">Términos de Uso</a> publicados en esta página.  Operar con el cotizador en línea implica aceptar los <a class="destacado" href="terminos.html">Términos de Uso</a> en los que se ofrece el servicio.</li>
					<li style="width: 220px;">
						<input type="checkbox" id="acepto" name="acepto">
						<label for="acepto" style="padding-left: 5px;">He leído y aceptado los <a class="destacado" href="terminos.html">Términos de Uso</a>.</label>
					</li>
				</ul>
