...
$var_aseguradoras = $_REQUEST['aseguradoras'];
if (isset($solicitud) && isset($var_aseguradoras)) {
    ...
    $solicitud->calcular_primas($aseguradoras, $flota->porcentaje_INMA);
    $_SESSION['solicitud'] = serialize($solicitud);
    $plantilla_grupo = new plantilla_grupo();

    $grupos = $plantilla_grupo->find_re_plantilla_detalle_tipo_seguro($flota->id, $solicitud->cotizacion->tipo_cobertura);
    ...
    <html>
        ...
        <body>
            ...
            <div id="contenedor">
                ...
                <div id="header">
                    <div class="center">
                        <p class="menu"><a class="current" href="index.php?i=<?php echo $id_flota;?>">Inicio</a><span>│</span><a href="terminos.html" target="_blank" onClick="window.open(this.href, this.target, 'width=500, height=400, resizable=0');
        ...
        ?>
                                                        ...
                                                        <tfoot class="gt">
                                                            <tr>
                                                                ...
                                                                <td colspan="2" class="right">Bs. <span class="total-prima" style="text-align: right"><?php echo formatMoney($total_fechas, true); ?></span></td>
                                                            </tr>
                                                        </tfoot>
                                                    </table></td>
                                                <?php
                                ...
                                ?>
                                <input id="cotizacion" name="cotizacion" type="hidden" value="">
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div id="footer">
                    <div class="center">
                        ...
                        <div id="legal">
                            ...
                            <input type="button" id="btn-enviar" class="boton boton-footer" value="Solicitar póliza" style="width: 125px; background-position: 15px 0px">
                        </div>
                    </div>
                </div>
            </div>
            <script src="../plugins/js/jquery-1.10.2.min.js"></script>
            <script src="../plugins/js/jquery-ui-1.10.4.custom.min"></script>
