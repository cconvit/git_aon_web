...
<html>
    ...
    <body>
        <div id="contenedor">
            ...
            <div id="contenido">
                <div class="center">
                    <p>Su solicitud ha sido enviada a Aon Risk Services Venezuela Corretaje de Seguros, C.A. En la brevedad un Ejecutivo de Atención al Cliente se comunicará con usted a través de los contactos proporcionados en el formulario de datos. Para mayor información contáctenos por los teléfonos: 0212 400 9290 Ι 0212 4009369 Ι 0212 4009324 Ι 0212 400 9208 o por correo electrónico a la cuenta ve.solicito.cotizacion@aon.com.</p>
                </div>
            </div>
            <div id="mensaje">
            ...
            <div id="footer">
                <div class="center">
                    ...
                    <div id="legal">
                        <input type="button" class="boton boton-footer" value="Volver a cotizar" style="width: 145px; background-position: 33px 0px" onclick="location.href = 'index.php?i=<?php echo $flota->id; ?>'">
                    </div>
                </div>
            </div>
        </div>
