...
var_dump($aseguradora);
      ...
      <p>Gracias por cotizar con nosotros. En la brevedad un Ejecutivo de Atenci&oacute;n al Cliente se comunicar&aacute; con usted. Si desea contactarnos directamente lo puede hacer a trav&eacute;s de los tel&eacute;fonos 212 4009324 | 212 4009322 o por correo electr&oacute;nico a la cuenta ve.solicito.cotizacion@aon.com</p><br /><table class="tbl-content" border="0" cellspacing="0" cellpadding="0">
		 ...
		 $body_html=$body_html.
			...
			<tfoot class="gt">
				<tr>
																							<td colspan="2">Prima Total '.$cobertura_seguro[0]->nombre.'</td>
